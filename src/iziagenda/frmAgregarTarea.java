...
public class frmAgregarTarea extends javax.swing.JFrame {
    ...
    /**
     * Creates new form frmAgregarTarea
     */
    ...
    public frmAgregarTarea(GregorianCalendar gg)
    {
        initComponents();
        extraClass.centrarFrame(this);
        generarAños();
    ...
    public void agregar()
    {
        try
        {
            ...
            else
            {
                ...
                fabricaClass.getUsuarioLogeado().agregarTarea(txtNombre.getText(), fecha,
