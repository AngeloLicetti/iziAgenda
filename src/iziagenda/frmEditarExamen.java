 ...
 * @author alumno
 */
public class frmEditarExamen extends javax.swing.JFrame {
    ...
    /**
     * Creates new form frmEditarExamen
     */
    
    public frmEditarExamen(){}
    
    public frmEditarExamen(PendienteClass pendiente, GregorianCalendar fechaPadre)
    {
        initComponents();
    ...
    private void initComponents() {
        ...
        pnlContenerdor.setMinimumSize(new java.awt.Dimension(400, 740));
        pnlContenerdor.setPreferredSize(new java.awt.Dimension(400, 740));
        ...
        lblLogIn.setText("Editar examen");
        ...
        lblCorreo.setText("Nombre del exámen:");
        ...
        pnlContenerdor.add(btnGuardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 620, 320, -1));
        ...
        getContentPane().add(pnlContenerdor, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 400, 740));
    ...
    private void txtNombreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtNombreActionPerformed
        ...
        try
        {
            if(txtNombre.getText().length()==0)
            {
                ...
                throw new Exception ("No deje ningún campo vacío. Ingrese el nombre del examen.");
            }
    ...
    private void txtRubroOtroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtRubroOtroActionPerformed
        ...
        try
        {
            ...
            {
                txtRubroOtro.requestFocus();
                throw new Exception ("No deje ningún campo vacío. Ingrese el rubro o curso del examen.");
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmEditarExamen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmEditarExamen().setVisible(true);
            }
        });
    }
    ...
    public void guardar()
    {
        try
        {
            ...
            else
            {
                ...
                //CAMBIAR ESTA PARTE!!!:
                ((ExamenClass)pendiente).cambiarDatos(txtNombre.getText(), fecha,
