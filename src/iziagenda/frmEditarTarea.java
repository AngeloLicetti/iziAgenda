 ...
 * @author alumno
 */
public class frmEditarTarea extends javax.swing.JFrame {
    ...
    /**
     * Creates new form frmEditarTarea
     */
    public frmEditarTarea(){}
    
    public frmEditarTarea(PendienteClass pendiente, GregorianCalendar fechaPadre) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblCorreo.setText("Nombre de la tarea:");
    ...
    private void txtNombreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtNombreActionPerformed
        ...
        try
        {
            if(txtNombre.getText().length()==0)
            {
                ...
                throw new Exception ("No deje ningún campo vacío. Ingrese el nombre de la tarea.");
            }
    ...
    private void txtRubroOtroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtRubroOtroActionPerformed
        ...
        try
        {
            ...
            {
                txtRubroOtro.requestFocus();
                throw new Exception ("No deje ningún campo vacío. Ingrese el rubro o curso de la tarea.");
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmEditarTarea.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmEditarTarea().setVisible(true);
            }
        });
    }
    ...
    public void guardar()
    {
        try
        {
            ...
            else
            {
                ...
                //CAMBIAR ESTA PARTE!!!:
                ((TareaClass)pendiente).cambiarDatos(txtNombre.getText(), fecha,
