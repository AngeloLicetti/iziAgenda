 ...
 * @author alumno
 */
public class frmAgregarRecordatorio extends javax.swing.JFrame {
    ...
    /**
     * Creates new form frmAgregarRecordatorio
     */
    public frmAgregarRecordatorio()
    {
        initComponents();
    ...
    public frmAgregarRecordatorio(GregorianCalendar gg)
    {
        initComponents();
        extraClass.centrarFrame(this);
        generarAños();
    ...
    private void initComponents() {
        ...
        lblLogIn.setText("Nuevo recordatorio");
        pnlContenerdor.add(lblLogIn, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 10, -1, -1));
        ...
        pnlContenerdor.add(btnAgregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 670, 320, -1));
        ...
        pnlContenerdor.add(btnVolver, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 730, 320, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmAgregarRecordatorio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public void agregar()
    {
        try
        {
            ...
            else
            {
                ...
                fabricaClass.getUsuarioLogeado().agregarRecordatorio(txtNombre.getText(), fecha,
